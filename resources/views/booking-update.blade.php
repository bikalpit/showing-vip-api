                                             ...
                                             <td
                                                ...
                                                <div
                                                   ...
                                                   <p style="font-size: 14px; line-height: 140%;"><span
                                                      ...
                                                      style="line-height: 39.2px; font-size: 28px;">Showing update
                                                      </span></strong></span>
                                                   </p>
                                                </div>
                                             </td>
                                          ...
                                          <tr>
                                             <td
                                                ...
                                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                   ...
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 18px; line-height: 28.8px;">Your showing status <span style="color:#00B050;font-weight: 500;">{{$status}}</span> </span></p>
                                                </div>
                                             </td>
                                          </tr>
                                       </tbody>
