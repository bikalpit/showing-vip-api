                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                   <tr>
                                                      <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                         <img align="center" border="0" src="{{$app_url}}public/mail-images/image-1.png" alt="Image" title="Image"
                                          ...
                                          <tr>
                                             <td
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                   <tr>
                                                      <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                         <img align="center" border="0" src="{{$app_url}}public/mail-images/image-2.png" alt="Image" title="Image"
                                             ...
                                             <td
                                                ...
                                                <div
                                                   ...
                                                   <p style="font-size: 14px; line-height: 140%;"><span
                                                      ...
                                                      style="line-height: 39.2px; font-size: 28px;">Forgot password
                                                      </span></strong></span>
                                                   </p>
                                                </div>
                                             </td>
                                          ...
                                          <tr>
                                             <td
                                                ...
                                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                   ...
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 18px; line-height: 28.8px;">Please click on below button to reset password </span></p>
                                                </div>
                                             </td>
                                          </tr>
                                       </tbody>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td
                                                ...
                                                align="left">
                                                <div align="center">
                                                   <a href="{{$app_url}}api/reset-password?token={{$verification_token}}" target="_blank"
                                                   ...
                                                   <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                                      ...
                                                      style="line-height: 19.2px; font-size: 16px;">RESET YOUR PASSWORD</span></strong></span></span>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
