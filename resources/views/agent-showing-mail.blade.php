                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 28px; line-height: 39.2px;"><strong><span
                                        style="line-height: 39.2px; font-size: 28px;">Property assign to you
                                      </span></strong></span></p>
                              </div>
                          ...
                          <tr>
                            <td
                              ...
                              align="left">
                                ...
                                <p style="font-size: 14px; line-height: 160%;"><span
                                    style="font-size: 18px; line-height: 28.8px;">You have a showing request on below property, Please check! </span></p><br>
                                <p style="font-size: 14px; line-height: 160%;">MLS ID: <span><b>{{$mls_id}}</b> </span></p>
                                <p style="font-size: 14px; line-height: 160%;">Originator: <span><b>{{$originator}}</b> </span></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 180%;"><span
                                    style="font-size: 16px; line-height: 28.8px;">© 2021-2022 Showing.VIP – All Rights Reserved
</span></p>
                              </div>
