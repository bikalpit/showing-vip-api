                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 28px; line-height: 39.2px;"><strong><span
                                        style="line-height: 39.2px; font-size: 28px;">{{$property_name}} Property assign to you
                                      </span></strong></span></p>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td
                              ...
                              <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 160%;"><span
                                    style="font-size: 18px; line-height: 28.8px;">{{$property_name}} Property assigned to you </span></p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
