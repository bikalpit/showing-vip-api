                                             ...
                                             <td
                                                ...
                                                <div
                                                   ...
                                                   <p style="font-size: 14px; line-height: 140%;"><span
                                                      ...
                                                      style="line-height: 39.2px; font-size: 28px;">Please create your password
                                                      </span></strong></span>
                                                   </p>
                                                </div>
                                             </td>
                                          ...
                                          <tr>
                                             <td
                                                ...
                                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                   ...
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 18px; line-height: 28.8px;">Click on below button to create
                                                      password </span>
                                                   </p>
                                                </div>
                                             </td>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td
                                                ...
                                                align="left">
                                                <div align="center">
                                                   <a href="{{$url}}{{$verification_token}}" target="_blank"
                                                   ...
                                                   <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                                      ...
                                                      style="line-height: 19.2px; font-size: 16px;">CREATE YOUR PASSWORD
