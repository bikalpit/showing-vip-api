                                             ...
                                             <td
                                                ...
                                                <div
                                                   ...
                                                   <p style="font-size: 14px; line-height: 140%;"><span
                                                      ...
                                                      style="line-height: 39.2px; font-size: 28px;">User Verification
                                                      </span></strong></span>
                                                   </p>
                                                </div>
                                             </td>
                                             ...
                                             <td
                                                ...
                                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 22px; line-height: 35.2px;">Hi {{$agent_name}}, </span></p>
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 18px; line-height: 28.8px;">Please click on below button to verify the owner {{$owner_name}}</span></p>
                                                </div>
                                             </td>
                                          </tr>
                                       </tbody>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td
                                                ...
                                                align="left">
                                                <div align="center">
                                                   <a href="{{$site_url}}api/verified-owner?auth={{$token}}&user={{$user_id}}&property={{$property_id}}" target="_blank"
