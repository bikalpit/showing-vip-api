                        ...
                        <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                           <div class="u-col u-col-100"
                              ...
                              <div style="width: 100% !important;">
                                 <div
                                    style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    <table style="font-family:'Cabin',sans-serif;margin-top: 30px;" role="presentation" cellpadding="0" cellspacing="0"
                                       width="100%" border="0">
                                       <tbody>
                                          <tr>
                                             <td
                                                style="overflow-wrap:break-word;word-break:break-word;padding: 0px 150px;font-family:'Cabin',sans-serif;"
                                                align="left">
                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px; float: left;width: 50%;">Showing Date: </span></p>
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px;float: left;width: 50%;">{{$booking_date}}</span></p>
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td
                                                ...
                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px; float: left;width: 50%;">Showing Time: </span></p>
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px;float: left;width: 50%;">{{$booking_time}}</span></p>
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td
                                                ...
                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px; float: left;width: 50%;">Buyer Name: </span></p>
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px;float: left;width: 50%;">{{$name}} </span></p>
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td
                                                ...
                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px; float: left;width: 50%;">Booked By: </span></p>
                                                   <p style="font-size: 14px; line-height: 160%;"><span
                                                      style="font-size: 16px; line-height: 35.2px;float: left;width: 50%;"> {{$name}} </span></p>
                                                </div>
                                             </td>
